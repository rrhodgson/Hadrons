/*
 * Epack_Decompress.hpp, part of Hadrons (https://github.com/aportelli/Hadrons)
 *
...
/*  END LEGAL */
#ifndef Hadrons_MUtilities_Epack_Decompress_hpp_
#define Hadrons_MUtilities_Epack_Decompress_hpp_
...
class Epack_DecompressPar: Serializable
{
public:
    GRID_SERIALIZABLE_CLASS_MEMBERS(Epack_DecompressPar,
...
class TEpack_Decompress: public Module<Epack_DecompressPar>
{
public:
...
public:
    // constructor
    TEpack_Decompress(const std::string name);
    // destructor
    virtual ~TEpack_Decompress(void) {};
    // dependency relation
...
MODULE_REGISTER_TMP(Epack_Decompress, ARG(TEpack_Decompress<FIMPL, HADRONS_DEFAULT_LANCZOS_NBASIS>), MUtilities);
MODULE_REGISTER_TMP(Epack_Decompress30, ARG(TEpack_Decompress<FIMPL, 30>), MUtilities);
MODULE_REGISTER_TMP(Epack_Decompress150, ARG(TEpack_Decompress<FIMPL, 150>), MUtilities);
MODULE_REGISTER_TMP(Epack_Decompress400, ARG(TEpack_Decompress<FIMPL, 400>), MUtilities);

MODULE_REGISTER_TMP(Epack_DecompressF, ARG(TEpack_Decompress<FIMPLF, HADRONS_DEFAULT_LANCZOS_NBASIS>), MUtilities);
MODULE_REGISTER_TMP(Epack_DecompressF30, ARG(TEpack_Decompress<FIMPLF, 30>), MUtilities);
MODULE_REGISTER_TMP(Epack_DecompressF150, ARG(TEpack_Decompress<FIMPLF, 150>), MUtilities);
MODULE_REGISTER_TMP(Epack_DecompressF400, ARG(TEpack_Decompress<FIMPLF, 400>), MUtilities);


/******************************************************************************
 *                 TEpack_Decompress implementation                      *
 ******************************************************************************/
// constructor /////////////////////////////////////////////////////////////////
template <typename FImpl, int nBasis, typename FImplIo>
TEpack_Decompress<FImpl, nBasis, FImplIo>::TEpack_Decompress(const std::string name)
: Module<Epack_DecompressPar>(name)
{}

// dependencies/products ///////////////////////////////////////////////////////
template <typename FImpl, int nBasis, typename FImplIo>
std::vector<std::string> TEpack_Decompress<FImpl, nBasis, FImplIo>::getInput(void)
{
...
template <typename FImpl, int nBasis, typename FImplIo>
std::vector<std::string> TEpack_Decompress<FImpl, nBasis, FImplIo>::getOutput(void)
{
...
// setup ///////////////////////////////////////////////////////////////////////
template <typename FImpl, int nBasis, typename FImplIo>
void TEpack_Decompress<FImpl, nBasis, FImplIo>::setup(void)
{
...
// execution ///////////////////////////////////////////////////////////////////
template <typename FImpl, int nBasis, typename FImplIo>
void TEpack_Decompress<FImpl, nBasis, FImplIo>::execute(void)
{
...
#endif // Hadrons_MUtilities_Epack_Decompress_hpp_
