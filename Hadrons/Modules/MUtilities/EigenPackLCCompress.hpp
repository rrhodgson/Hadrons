...
MODULE_REGISTER_TMP(EigenPackLCCompress30  , ARG(TEigenPackLCCompress<FIMPL , 30>), MUtilities);
MODULE_REGISTER_TMP(EigenPackLCCompress150 , ARG(TEigenPackLCCompress<FIMPL , 150>), MUtilities);
...
MODULE_REGISTER_TMP(EigenPackLCCompress30F , ARG(TEigenPackLCCompress<FIMPLF, 30>), MUtilities);
MODULE_REGISTER_TMP(EigenPackLCCompress150F, ARG(TEigenPackLCCompress<FIMPLF, 150>), MUtilities);
...
{
    LOG(Message) << "Setting up local coherence eigenvector compressor (" << nBasis << " fine eigenvectors)" << std::endl;
