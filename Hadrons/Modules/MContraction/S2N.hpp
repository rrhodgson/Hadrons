...
Source file: Hadrons/Modules/MContraction/S2N.hpp
...
#ifndef Hadrons_MContraction_S2N_hpp_
#define Hadrons_MContraction_S2N_hpp_
...
class S2NPar: Serializable
{
public:
    GRID_SERIALIZABLE_CLASS_MEMBERS(S2NPar,
                                    std::string, quTi,
                                    std::string, quTf,
                                    std::string, quSpec,
                                    std::string, qdTf,
...
class TS2N: public Module<S2NPar>
{
public:
...
MODULE_REGISTER_TMP(S2N, ARG(TS2N<FIMPL>), MContraction);
...
// constructor /////////////////////////////////////////////////////////////////
template <typename FImpl>
TS2N<FImpl>::TS2N(const std::string name)
: Module<S2NPar>(name)
{}

// dependencies/products ///////////////////////////////////////////////////////
template <typename FImpl>
std::vector<std::string> TS2N<FImpl>::getInput(void)
{
...
template <typename FImpl>
std::vector<std::string> TS2N<FImpl>::getOutput(void)
{
...
void TS2N<FImpl>::execute(void)
{
    ...
    saveResult(par().output, "S2N", result);
...
#endif // Hadrons_MContraction_S2N_hpp_
