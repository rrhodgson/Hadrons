/*
 * MixedPrecisionRBPrecCG_SingleDefl.hpp, part of Hadrons (https://github.com/aportelli/Hadrons)
 *
...
/*  END LEGAL */
#ifndef Hadrons_MSolver_MixedPrecisionRBPrecCG_SingleDefl_hpp_
#define Hadrons_MSolver_MixedPrecisionRBPrecCG_SingleDefl_hpp_
...
class MixedPrecisionRBPrecCG_SingleDeflPar: Serializable
{
public:
    GRID_SERIALIZABLE_CLASS_MEMBERS(MixedPrecisionRBPrecCG_SingleDeflPar,
...
class TMixedPrecisionRBPrecCG_SingleDefl: public Module<MixedPrecisionRBPrecCG_SingleDeflPar>
{
public:
...
public:
    // constructor
    TMixedPrecisionRBPrecCG_SingleDefl(const std::string name);
    // destructor
    virtual ~TMixedPrecisionRBPrecCG_SingleDefl(void) {};
    // dependency relation
...
MODULE_REGISTER_TMP(MixedPrecisionRBPrecCG_SingleDefl, ARG(TMixedPrecisionRBPrecCG_SingleDefl<FIMPLF, FIMPLD>), MSolver);
MODULE_REGISTER_TMP(ZMixedPrecisionRBPrecCG_SingleDefl, ARG(TMixedPrecisionRBPrecCG_SingleDefl<ZFIMPLF, ZFIMPLD>), MSolver);

/******************************************************************************
 *                 TMixedPrecisionRBPrecCG_SingleDefl implementation                             *
 ******************************************************************************/
// constructor /////////////////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter, int nBasis>
TMixedPrecisionRBPrecCG_SingleDefl<FImplInner, FImplOuter, nBasis>
::TMixedPrecisionRBPrecCG_SingleDefl(const std::string name)
: Module<MixedPrecisionRBPrecCG_SingleDeflPar>(name)
{}

// dependencies/products ///////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter, int nBasis>
std::vector<std::string> TMixedPrecisionRBPrecCG_SingleDefl<FImplInner, FImplOuter, nBasis>
::getInput(void)
{
...
// setup ///////////////////////////////////////////////////////////////////////
template <typename FImplInner, typename FImplOuter, int nBasis>
void TMixedPrecisionRBPrecCG_SingleDefl<FImplInner, FImplOuter, nBasis>
::setup(void)
{
    ...
    auto makeSolver = [&imat, &omat, guesserPt32, guesserPt64, Ls, this](bool subGuess)
    {
        ...
        (FermionFieldOuter &sol, const FermionFieldOuter &source) 
        {
            ...
            MixedPrecisionConjugateGradient_SingleDefl<FermionFieldOuter, FermionFieldInner> 
...
#endif // Hadrons_MSolver_MixedPrecisionRBPrecCG_SingleDefl_hpp_
