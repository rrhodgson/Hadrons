...
::setup(void)
{
    ...
    auto makeSolver = [&D_outer, &D_inner, &omat, Ls_outer, Ls_inner, &Umu, residual, this] (bool subGuess) mutable
    {
        return [&D_outer, &D_inner, &omat, Ls_outer, Ls_inner, &Umu, subGuess, residual, this]
