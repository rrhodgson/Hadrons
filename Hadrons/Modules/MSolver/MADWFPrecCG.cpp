...
/*  END LEGAL */
#include <Hadrons/Modules/MSolver/MADWFPrecCG.hpp>
...
template class Grid::Hadrons::MSolver::TMADWFPrecCG<ZFIMPLD, FIMPLD, HADRONS_DEFAULT_LANCZOS_NBASIS>; // inner in double precision
