...
MODULE_REGISTER_TMP(LoadFermionEigenPackIo64, ARG(TLoadEigenPack<FermionEigenPack<FIMPLF, FIMPL>, GIMPLF>), MIO);
MODULE_REGISTER_TMP(LoadFermionEigenPackF, ARG(TLoadEigenPack<FermionEigenPack<FIMPLF, FIMPLF>, GIMPLF>), MIO);
#endif
