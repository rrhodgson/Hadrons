...
MODULE_REGISTER_TMP(LoadCoarseFermionEigenPack150 , ARG(TLoadCoarseEigenPack<CoarseFermionEigenPack<FIMPL, 150>,GIMPL>), MIO);
...
MODULE_REGISTER_TMP(LoadCoarseFermionEigenPack150F, ARG(TLoadCoarseEigenPack<CoarseFermionEigenPack<FIMPLF, 150>,GIMPLF>), MIO);
